...
function copy_libs {
    ...
    copy_lib_env libboost_charconv "$dest"
    copy_lib_env libboost_chrono "$dest"
    copy_lib_env libboost_container "$dest"
    copy_lib_env libboost_context "$dest"
    copy_lib_env libboost_date_time "$dest"
    copy_lib_env libboost_filesystem "$dest"
    copy_lib_env libboost_local "$dest"
    copy_lib_env libboost_locale "$dest"
    copy_lib_env libboost_process "$dest"
