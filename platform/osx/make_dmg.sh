...
universal_copy_lib $ENV libicu18n.52 "$WORK/$libs"
universal_copy_lib $ENV libicudata.52 "$WORK/$libs"
universal_copy_lib $ENV libicuio.52 "$WORK/$libs"
universal_copy_lib $ENV libicule.52 "$WORK/$libs"
universal_copy_lib $ENV libiculx.52 "$WORK/$libs"
universal_copy_lib $ENV libicutest.52 "$WORK/$libs"
universal_copy_lib $ENV libicutu.52 "$WORK/$libs"
universal_copy_lib $ENV libicuuc.52 "$WORK/$libs"
universal_copy_lib $ENV libicudt.52 "$WORK/$libs"
universal_copy_lib $ENV libicuin.52 "$WORK/$libs"
